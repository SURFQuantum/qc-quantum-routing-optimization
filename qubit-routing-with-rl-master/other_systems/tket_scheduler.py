...
# Changes tp extensions because pytket.qiskit did not work
...
def schedule_swaps(environment, circuit, qubit_locations=None, safety_checks_on=False, decompose_cnots=False):
    ...
    # Changes convert_index_mapping to place_with_map because convert_index_mapping does not exist anymore
    initial_map = place_with_map(circuit, initial_index_map)
